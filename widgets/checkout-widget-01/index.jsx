...
function CheckoutWidget01({ routingTable, now, elementProps }) {
  ...
  // if (!store) {
  //   console.error('[CheckoutWidget01] window.__APP_REDUX_STORE__ not found');
  //   return null;
  // }
    ...
    useEffect(()=>{
        if(customer?.uuid){
            setPurchaserData({
                purchaser_name: `${customer?.first_name||''}${customer?.last_name||''}`,
                purchaser_cellphone: customer?.phone||'',
                purchaser_email: customer?.email||'',
            })
        } else {
            setPurchaserData({ purchaser_name: '', purchaser_cellphone: '', purchaser_email: '' })
        }
    }, [customer])
    useEffect(()=>{
        if(sameAsReceiver){
            setCheckoutData(prev => ({
                ...prev,
                shipping_name: purchaserData.purchaser_name,
                shipping_cellphone: purchaserData.purchaser_cellphone,
                shipping_email: purchaserData.purchaser_email,
            }))
        }
    ...
    const checkout = ()=>{
        setSubmitMessage({ type: '', text: '' })
        var allValid = true;
        if(!purchaserInfoValidator.current.allValid()){
            purchaserInfoValidator.current.showMessages()
                ...
                >
      ...
      
                  {
                      ...
                      <Fragment>
                          ...
                          <div className={clsx('購買人資料框', style['購買人資料框'])}>
                              <div className={clsx('購買人資料標題框', style['購買人資料標題框'])}>
                                  <h5 className={clsx('購買人資料標題', style['購買人資料標題'])}>購買人資料</h5>
                              </div>

                              <div className={clsx(style['購買人姓名框'], '購買人姓名框')}>
                                  <label className={clsx(style['購買人姓名-標籤'], '購買人姓名-標籤')}>購買人姓名：</label>
                                  <input
                                      className={clsx(style['購買人姓名-輸入'], '購買人姓名-輸入')}
                                      type="text"
                                      name="purchaser_name"
                                      placeholder="購買人姓名"
                                      value={purchaserData.purchaser_name}
                                      onChange={(e) => { setPurchaserData({...purchaserData, purchaser_name: e.target.value}) }}
                                      onBlur={() => {
                                          purchaserInfoValidator.current.showMessageFor("purchaser_name")
                                          forceUpdate(new Date())
                                      }}
                                  />
                                  {purchaserInfoValidator.current.message("purchaser_name", purchaserData.purchaser_name, "required", {className:'不合規提示'})}
                              </div>
                              ...
                              <div className={clsx(style['購買人電話框'], '購買人電話框')}>
                                  ...
                                  />
                                  {purchaserInfoValidator.current.message("purchaser_cellphone", purchaserData.purchaser_cellphone, "required", {className:'不合規提示'})}
                              </div>

                              <div className={clsx(style['購買人信箱框'], '購買人信箱框')}>
                                  <label className={clsx(style['購買人信箱-標籤'], '購買人信箱-標籤')}>購買人信箱：</label>
                                  <input
                                      className={clsx(style['購買人信箱-輸入'], '購買人信箱-輸入')}
                                      type="email"
                                      ...
                                      onBlur={() => {
                                          purchaserInfoValidator.current.showMessageFor("purchaser_email")
                                          forceUpdate(new Date())
                                      }}
                                  />
                                  {purchaserInfoValidator.current.message("purchaser_email", purchaserData.purchaser_email, "required|email", {className:'不合規提示'})}
                              </div>
                          </div>
                          ...
                          <div className={clsx('運送資料框',style['運送資料框'])}>
                              ...
                              <div className={clsx('收件人同購買人框', style['收件人同購買人框'])}>
                                  <label className={clsx('收件人同購買人-標籤', style['收件人同購買人-標籤'])}>
                                      <input
                                          className={clsx('收件人同購買人-勾選', style['收件人同購買人-勾選'])}
                                          type="checkbox"
                                          checked={sameAsReceiver}
                                          onChange={(e) => { setSameAsReceiver(e.target.checked) }}
                                      />
                                      <span className={clsx('收件人同購買人-文字', style['收件人同購買人-文字'])}>收件人同購買人</span>
                                  </label>
                              </div>
...
window.CheckoutWidget01 = {
  mount(containerEl, props = {}) {
