...
const TimeoutEventForm=({ event, setEvent, removeEvent})=>{
        ...
        <Fragment>
            <div style={{
...

                {
                    ...
                    // (webpage?.timeout_events||[]).map((event,key)=>(<div key={key}>
                    //     {key}
                    // </div>))
                    // :
                ...
                <div style={{display:'flex', flexDirection:'row', justifyContent:'start' , alignContent:'center', marginTop:'10px'}}> 
                    ...
                    <div>
                        <input
                            ...
                            value=''
                            onChange={(e)=>{
                                setEvent({...event, enable:e.target.checked})    }}                    
                        />
                    </div>
                </div>
                <div style={{display:'flex', flexDirection:'row', justifyContent:'start' , alignContent:'center', marginTop:'10px'}}> 
                    ...
                    value={event?.emit_event_name||''} onChange={(e)=>{setEvent({...event, emit_event_name:e.target.value})}}/>
                </div> 
                ...
                <div style={{display:'flex', flexDirection:'row', justifyContent:'start' , alignContent:'center', marginTop:'10px'}}> 
                    ...
                    <input type='number' 
                    style={{ paddingLeft:"20px", paddingRight:"20px", marginLeft:'auto'}}
                    value={event?.timeout||''} onChange={(e)=>{setEvent({...event, timeout:parseInt(e.target.value)})}}/>
                </div> 
